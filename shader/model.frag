...
//     // 漫反射光
//     vec4 diffuse=mix(mix(texture(texture0,fragTextcoord),texture(texture1,fragTextcoord),mixPercent),texture(material.diffuseMap_1,fragTextcoord),0.1);
...
void main()
{
    ...
    // fragColor = texture(material.diffuseMap_1,fragTextcoord);
    fragColor = texture(diffuseMap_1,fragTextcoord);
}